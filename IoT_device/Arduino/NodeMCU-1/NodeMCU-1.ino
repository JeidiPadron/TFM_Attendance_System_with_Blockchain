/* -----------------------------------------------------------------------------
  ...
  Biometric work attendance management and logging with a blockchain system
  Author: Jeidi Padron Nuñez
  Date: July 2021
  version 1.0

  -----------------------------------------------------------------------------
  This code was based on code created by Electronics Tech youtube channel for 
  the Biometric attendance project with NodeMCU.
  available at https://youtu.be/Lo7BQVSx5zM

  Test code provided by vendor
  Adafruit    - Fingerprint model JM-101B
  AZ delivery - OLED I2C 128 x 64 pixel display for Arduino and Raspberry Pi
  AZ delivery - NodeMCU V3 Lolin
...
////////////////////////////////////////////////////
//     SSD1306 display -  I2C Pins (22 SCL, 21 SDA)
////////////////////////////////////////////////////
...
////////////////////////////////////////////////////
//     Declaration of Wi_Fi credentials.
////////////////////////////////////////////////////
//const char *ssid = "Jeidi";                      //Enter your WiFi values
//const char *password = "sabrina12";

//***** wi-fi CASA***
const char *ssid = "vodafoneE35B"; 
const char *password = "C2PLR75PR5HR87";

////////////////////////////////////////////////////
//     Declaration of IoT Device ID
////////////////////////////////////////////////////
//const char* device_token  = "Device Token";
const char* device_token  = "ea16b938f7e73a9d";


////////////////////////////////////////////////////
//     Declaration of IoT Edge Web Server and Database.
////////////////////////////////////////////////////
String getData, Link;
String URL = "http://192.168.0.22/iotedge/getdata.php"; //computer IP or the server domain

int FingerID = 0, t1, t2;                        // The Fingerprint ID from the scanner 
bool device_Mode = false;                        // Default Mode is Enrollment
